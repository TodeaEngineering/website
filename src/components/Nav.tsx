      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="flex items-center justify-between h-[60px]">
          ...
          <div className="hidden md:flex items-center gap-7">
            ...
            <a href="#contact" className="text-[13px] font-semibold bg-brand text-white px-5 py-2 rounded-full hover:opacity-80 transition-opacity">
              {t('contact')}
            </a>
          </div>
        ...
        >
          <div className="pb-5 flex flex-col gap-3">
            ...
            <a href="#contact" onClick={() => setMobileOpen(false)} className="text-sm font-semibold bg-brand text-white px-5 py-2 rounded-full text-center">
              {t('contact')}
            </a>
          </div>
        </div>
